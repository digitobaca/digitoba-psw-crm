...
const animations = {
  ...
  plus: {
    line1: {
      initial: { rotate: 0, x1: 6, y1: 18, x2: 18, y2: 6, transition: { ease: 'easeInOut', duration: 0.3, delay: 0.1 } },
      animate: { rotate: 45, x1: 7.1, y1: 16.9, x2: 16.9, y2: 7.1, transition: { ease: 'easeInOut', duration: 0.3, delay: 0.1 } },
    },
    line2: {
      initial: { rotate: 0, x1: 6, y1: 6, x2: 18, y2: 18, transition: { ease: 'easeInOut', duration: 0.3 } },
      animate: { rotate: 45, x1: 7.1, y1: 7.1, x2: 16.9, y2: 16.9, transition: { ease: 'easeInOut', duration: 0.3 } },
    },
  },
};

 ...
 * Source: imskyleen/animate-ui, apps/www/registry/icons/icon.
 * Converted from TypeScript to plain JSX for this Vite/JS project; logic is
 * unchanged from upstream. This is the shared engine every animated icon in
 * `components/animate-ui/icons/*` is built on — it owns the hover/tap/
 * view/imperative animation triggers, looping, and variant resolution so
 * each icon file only has to declare its own SVG paths + motion variants.
 */
...
import { Slot } from '@/components/animate-ui/primitives/slot.jsx';

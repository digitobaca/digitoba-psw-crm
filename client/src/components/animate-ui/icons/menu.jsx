...
const animations = {
  default: {
    ...
    line2: {
      initial: { opacity: 1 },
      animate: { opacity: 0, transition: { ease: 'easeInOut', duration: 0.2 } },
    },
    line3: {
      initial: { rotate: 0, x: 0, y: 0 },
      animate: {
...
const IconComponent = React.forwardRef(function IconComponent({ size, ...props }, ref) {
  ...
  return (
    <motion.svg
      ...
      {...props}
    >
      <motion.line x1={4} y1={6} x2={20} y2={6} variants={variants.line1} initial="initial" animate={controls} />
      <motion.line x1={4} y1={12} x2={20} y2={12} variants={variants.line2} initial="initial" animate={controls} />
      <motion.line x1={4} y1={18} x2={20} y2={18} variants={variants.line3} initial="initial" animate={controls} />
    </motion.svg>
  );
});
